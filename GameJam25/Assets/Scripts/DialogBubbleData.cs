...
public static class DialogBubbleData
{
    static readonly List<Line> _lineData = new()
    {
        ...
        new ("Hero_NeedsAir", 0.4f, "What's the word for \"thirsty\", but for air?" ),
        ...
        new ("Hero_StartPhase4", 1f, "Guess I'll have to resort to performance enhancing chemicals. " ),
        new ("Hero_StartPhase5", 1f, "This is it! You're out of time! " ),
        ...
        new ("Hero_WrongElementAttack", 1f, "Ruff... Guess it's immune to that... " ),
        new ("Hero_WrongElementAttack", 1f, "Pay attention, that was the wrong weapon! " ),
        new ("Hero_CorrectElementAttack", 1f, "Oooowwwwwuuuu! That one worked! " ),
        new ("Hero_ReignOfDestruction", 1f, "Leviathan! I'm here to stop you for good! " ),
        new ("Hero_ReignOfDestruction", 1f, "You've gone too far, Leviathan! I'm here to save the day! " ),
        new ("Hero_IntroducePlayer", 1f, "Oh, and the frog is helping... " ),
        new ("Hero_ReignOfDestruction", 1f, "I'm here to reclaim the sea! You're done being trouble, Leviathan! " ),
        new ("Hero_IntroducePlayer", 1f, "And if that wasn't enough, that little guy is here, too! " ),
        new ("Hero_Brag", 1f, "Get wrecked, cephalojerk! " ),
        new ("Hero_Brag", 1f, "I'm the SEAWOLF, now! " ),
        new ("Hero_LostDivingGear", 1f, "You think I need diving gear to beat you? I'll hold my breath! " ),
        new ("Hero_StartPhase2", 1f, "I'm surprised you made it this far! Now I'm serious! " ),
        new ("Hero_StartPhase2", 1f, "You're going to have to call your friends if you want to last much longer! " ),
        new ("Hero_StartPhase2", 1f, "A few starfish aren't going to stop me! Crank it up a notch! " ),
        new ("Hero_StartPhase2", 1f, "What else do you have to squirt at me? " ),
    };
